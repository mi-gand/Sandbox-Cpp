...
const int width = 3;
const int height = 3;
const int8_t Incorrect = 0;														//для исключений
...
{	
		...
		int win = 0;
		if (gameBoard[0][0] == symbol and gameBoard[0][1] == symbol and gameBoard[0][2]) win++;
		if (gameBoard[1][0] == symbol and gameBoard[1][1] == symbol and gameBoard[1][2]) win++;
		if (gameBoard[2][0] == symbol and gameBoard[2][1] == symbol and gameBoard[2][2]) win++;

		if (gameBoard[0][0] == symbol and gameBoard[1][0] == symbol and gameBoard[2][0]) win++;
		if (gameBoard[0][1] == symbol and gameBoard[1][1] == symbol and gameBoard[2][1]) win++;
		if (gameBoard[0][2] == symbol and gameBoard[1][2] == symbol and gameBoard[2][2]) win++;

		if (gameBoard[0][0] == symbol and gameBoard[1][1] == symbol and gameBoard[2][2]) win++;
		if (gameBoard[0][2] == symbol and gameBoard[1][1] == symbol and gameBoard[2][0]) win++;
		std::cout << "Строка - "<<gameBoard[0][2] << gameBoard[1][1] << gameBoard[2][0] << std::endl;
